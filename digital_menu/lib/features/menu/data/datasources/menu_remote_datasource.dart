...
class MenuRemoteDataSourceImpl implements MenuRemoteDataSource {
  ...
  CollectionReference<MenuCategoryModel> get _categoriesRef =>
      _firestore.collection(FirestoreCollections.categories).withConverter<MenuCategoryModel>(
  ...
  CollectionReference<DishModel> get _dishesRef =>
      _firestore.collection(FirestoreCollections.dishes).withConverter<DishModel>(
